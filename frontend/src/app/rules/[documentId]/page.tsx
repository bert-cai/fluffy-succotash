  ...
  return (
    <div className="mx-auto max-w-2xl px-4 py-8">
      <header className="mb-6">
        ...
        <a href="/" className="mt-2 block text-xl font-bold text-slate-900">
          Participate
        </a>
      </header>
      ...
      {!loading && analysis && rule && (
        <div className="mt-6 space-y-6">
          ...
          <button
            ...
            className="w-full rounded-lg bg-blue-600 px-6 py-3 text-sm font-medium text-white transition-colors hover:bg-blue-700 disabled:bg-blue-400 sm:w-auto"
          >
            {startingInterview
              ? "Starting interview..."
